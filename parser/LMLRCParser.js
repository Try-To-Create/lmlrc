...
export default class LMLRCParser extends LyricsParser {
    constructor() {
        super(...arguments);
        this.version = '1.0.0';
                ...
                method(matched, info) {
                    ...
                    time.match(regexp).forEach((time) => {
                        ...
                        if (lines && lines.length) {
                            ...
                            const fonts = line.fonts = line.fonts || [];
                            // Present font.
                            const font = { length: +(length || 1) };
    ...
    getTimeString(start, end, previousLine) {
                ...
                lines.forEach((line, index) => {
                    ...
                    if (fonts) {
                        ...
                        fonts.forEach((font, index) => {
                            ...
                            const duration = font.duration || (nextFont && nextFont.start ? nextFont.start - fontStart : 1000);
